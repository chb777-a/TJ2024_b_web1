		...
		.then( data =>{
			...
			if( data == null ){console.log('비로그인상태');
				...
				html += `<li class="nav-item"> 
							<a class="nav-link" href="#"> <img class="header_profile" src="/tj2024_b_web1/upload/${ data.mimg }" /> ${ data.mid } 님  </a> 
						</li>
						<li class="nav-item"> <a class="nav-link" href="/tj2024_b_web1/member/login.jsp">마이페이지</a> </li>
