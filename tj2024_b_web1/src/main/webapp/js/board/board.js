...
// /tj2024_b_web1/board/board.jsp?cno=1
// /tj2024_b_web1/board/board.jsp?cno=2
// /tj2024_b_web1/board/board.jsp?cno=3
...
const findall = ( ) => {
	...
	fetch( `/tj2024_b_web1/board?cno=${ cno }&page=${ page }` , option )
		.then( r => r.json() )
