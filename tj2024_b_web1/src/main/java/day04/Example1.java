...
public class Example1 extends HttpServlet{
	//1. 쿼리스트링 ex
	// http get url : http://localhost:8080/tj2024_b_web1/day04/example1?value1=임의값&value2=임의값
	@Override
	...
	//2. HTTP header body(본문) ex
	// http post url : http://localhost:8080/tj2024_b_web1/day04/example1
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		resp.getWriter().print(jsonResult); // 변환한 문자열(JSON) 반환
	}
